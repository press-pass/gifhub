...
Go through the full flow of the app in `home-buyer/` (signup, login, link with
Plaid or not, answer the advisor's questions, change assumptions, etc.) and find
bugs.
...
harness in `home-buyer/e2e/` is already set up). Then record the UI of that e2e
